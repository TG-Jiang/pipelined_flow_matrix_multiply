...
We present waveform examples for 24 selected cases where N×M ≤ 15, and an additional Matlab verification Figure when N=5 and M=3.
...
## case N=6 to 14 and M=1 are omitted for page limit
